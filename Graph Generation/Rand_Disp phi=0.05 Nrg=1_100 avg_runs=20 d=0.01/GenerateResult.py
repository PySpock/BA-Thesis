...
title = 'Rand_Disp phi=0.05 Nrg=1_100 avg=20 d=0.01'

rfileb = 'CompiledResult Nmax=100.txt'
rfiles = 'CompiledResult Nmax=50.txt'

bkeys, bvals = getData(rfileb)
skeys, svals = getData(rfiles)
