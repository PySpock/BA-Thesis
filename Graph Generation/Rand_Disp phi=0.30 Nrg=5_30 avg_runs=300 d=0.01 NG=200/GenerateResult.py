...
rfile_vclose = 'CompiledResult NGRID=200.txt'

vckeys, vcvals = getData(rfile_vclose)

title = 'phi=0.3 Nrg=5_30 avg_runs=300 d=0.01 ngrid=200'
...
ax.errorbar(vcvals[5], vcvals[0], yerr=vcvals[1], fmt='ko', label='Simulationswert $\lambda(N) \quad d=0.01$')
